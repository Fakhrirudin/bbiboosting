          ...
          <div className="max-w-sm mx-auto">
            ...
            <form>
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="full-name">Nama <span className="text-red-600">*</span></label>
              ...
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  ...
                  <input id="password" type="password" className="form-input w-full text-gray-300" placeholder="Password (minimal 10 karakter)" required />
                </div>
              </div>
